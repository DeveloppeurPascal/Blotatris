...
///
/// ***************************************************************************
/// File last update : 2025-03-16T17:49:36.000+01:00
/// Signature : 088dde3e3b1ef5aafa4d8142cf6cece541c0c12b
/// ***************************************************************************
/// </summary>
...
const
  CTxtEN = '''
Blotatris was developed for the Kenney Jam 2021 during live coding sessions on Twitch with FireMonkey under Delphi.
...
Graphics (sprites and user interface) from Kenney.nl and Adobe Stock.
...
To find out more, visit https://blotatris.gamolf.fr

''';
   CTxtFR = '''
Blotatris a été développé lors la Kenney Jam 2021 en direct sur Twitch avec FireMonkey sous Delphi.
...
Les graphismes (sprites et interface utilisateur) proviennent de Kenney.nl et Adobe Stock.
...
Pour en savoir plus, visitez https://blotatris.gamolf.fr
